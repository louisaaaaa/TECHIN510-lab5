...
def generate_answer(prompt, chosen_situation):
  ...
  prompt = "This is a situation puzzle, the situation is:" + chosen_situation+ " The question is: "+ prompt + "Please try to answer it with only yes or no."
...
def generate_score(prompt, answer):
  prompt = "This is a situation puzzle, the answer is:" + answer+ " The user's answer is: "+ prompt + "Please give the user the corrent answer and tell them how their answer is."
  response = model.generate_content(prompt)
